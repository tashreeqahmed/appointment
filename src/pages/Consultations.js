...
const Layout = ({ children }) => {
    ...
    const removeToken = async(userToken) => {
        try {
            const response = await axios.post('/api/user/login', userToken);
        ...
        <div className = 'main'>
            <div className = 'd-flex layout'>
                <div className = 'sidebar'>
                    ...
                    <Link to = "/consultations"><Button className='con-word my-1' htmlType='submit'><mark><i class = "con-but ri-file-list-line"></i>CONSULTATIONS</mark></Button></Link>
                    <Link to = "/request"><Button className='req-word my-1' htmlType='submit'><i class = "req-but ri-hospital-line"></i>SUBMIT REQUEST</Button></Link>
