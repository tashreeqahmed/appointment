        ...
        <div className = 'main'>
            <div className = 'd-flex layout'>
                <div className = 'sidebar'>
                    ...
                    <Link to = "/consultationsLec"><Button className='con-word my-1' htmlType='submit'><i class = "con-but ri-file-list-line"></i>CONSULTATIONS</Button></Link>
                    <Link to = "/profileLec"><Button className='prof-word my-1' htmlType='submit'><mark><i class = "prof-but ri-user-line"></i>PROFILE</mark></Button></Link>
